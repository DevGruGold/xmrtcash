            ...
            <div className="max-w-7xl mx-auto space-y-8">
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto">
                  Decentralized mobile mining, mesh networking, and privacy-first DeFi platform
                </p>
                <div className="flex items-center justify-center gap-4 pt-4">
                  <Badge className="bg-green-100 text-green-800 border-green-200 dark:bg-green-900/30 dark:text-green-400 px-4 py-2">
                    <Activity className="w-4 h-4 mr-2" />
                    Live Network
                  </Badge>
                  <Badge className="bg-blue-100 text-blue-800 border-blue-200 dark:bg-blue-900/30 dark:text-blue-400 px-4 py-2">
